...
##'     }
##'
##'     \item{\code{exact}:   Logical scalar indicating if growth should increase the size by \emph{exactly} \code{n} elements (if \codE{TRUE}) or so that \emph{at least} \code{n} additional elements will fit.
##'     }
##'   }
##' }
##' \item{\code{size}}{
